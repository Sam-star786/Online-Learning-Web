...
$sql = mysqli_query($con, "SELECT COUNT(*) AS `count` FROM `user`");
$row = mysqli_fetch_assoc($sql);
$count = $row['count'];
//Count  Videos
$sql = mysqli_query($con, "SELECT COUNT(*) AS `count` FROM `video`");
$row = mysqli_fetch_assoc($sql);
$count1 = $row['count'];
?>
<!DOCTYPE html>
            ...
            <div class="col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <h3 class="card-title"><?php echo $count1?></h3>
                </div>
                ...
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-header card-header-primary">
                      ...
                      <p class="card-category">New registerd usres</p>
                    </div>
                    <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php
                        require_once('conn.php');
                        $sql = mysqli_query($con, "SELECT * FROM user ORDER BY id DESC LIMIT 10");
